...
public class CardUtil {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String IDCardNum = "350128196212162810";
        String result = IDCardNum.substring(IDCardNum.length()-6,IDCardNum.length());
        try {
            System.out.println(result);
            System.out.println(JsonUtil.toJson(CardUtil.getCarInfo(IDCardNum)));
        } catch (Exception e) {
            e.printStackTrace();
        }
