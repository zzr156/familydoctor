package com.ylz.easemob.server.example.api;
...
public interface ChatGroupAPI {
	 ...
	 *            用户ID或用户名，数组形式
	 * @return
	 * @see com.ylz.easemob.server.example.comm.body.UserNamesBody
	 */
	 ...
	 *            新群主ID或用户名
	 * @return
     * @see com.ylz.easemob.server.example.comm.body.GroupOwnerTransferBody
	 */
