...
public class AdvancedUtil {
	 ...
	 * @return true | false
	 */
	public static boolean sendCustomMessage(String accessToken, String jsonMsg,String opid,String msg) {
		if(StringUtils.isBlank(accessToken)|| StringUtils.isBlank(opid)){
			System.out.println("sendCustomMessage----ajo--为空");
			return false;
		}
		...
		if (null != jsonObject) {
			...
			if (0 == errorCode) {
				result = true;
				log.warn("客服消息发送成功!"+msg);
			} else {
				log.error("客服消息发送失败!"+msg+"errcode:{} errmsg:{}", errorCode, errorMsg);
			}
		}
		return result;
	}
	...
	public static WeixinOauth2Token getOauth2AccessToken(String appId, String appSecret, String code) {
		if(StringUtils.isBlank(appId)|| StringUtils.isBlank(appSecret)|| StringUtils.isBlank(code)){
			System.out.println("getOauth2AccessToken----aac--为空");
			return null;
		}
		...
		if (null != jsonObject) {
			try {
				...
				//log.info(jsonObject.getString("openid")+"获取网页授权凭证成功！");
				if(jsonObject.getString("openid")!=null&&jsonObject.getString("openid").length()>5){
					System.out.println(jsonObject.getString("openid").substring(jsonObject.getString("openid").length()-5, jsonObject.getString("openid").length())+"获取网页授权凭证成功！");
				}else{
				...
				//System.out.println(new Date()+"获取网页授权凭证失败 ");
			}
		}
		return wat;
	}
	...
	public static WeixinOauth2Token refreshOauth2AccessToken(String appId, String refreshToken) {
		if(StringUtils.isBlank(appId)|| StringUtils.isBlank(refreshToken)){
			System.out.println("refreshOauth2AccessToken----ar--为空");
			return null;
		}
		WeixinOauth2Token wat = null;
		// 拼接请求地址
	...
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
		if(StringUtils.isBlank(accessToken)|| StringUtils.isBlank(openId)){
			System.out.println("getSNSUserInfo----ao--为空");
			return null;
		}
