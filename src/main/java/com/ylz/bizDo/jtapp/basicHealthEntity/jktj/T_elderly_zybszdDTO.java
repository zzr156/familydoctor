 ...
 * All Right Reverse.
 * Class Name: <code>T_elderly_zybszdDTO</code>.
 */
...
public class T_elderly_zybszdDTO implements Serializable {
	public class IFindGroup {
	...
	public boolean equals(Object o) {
		if (!(o instanceof T_elderly_zybszdDTO)) {
			return false;
		}
		if (o == this) {
            return true;
        }
		T_elderly_zybszdDTO me = (T_elderly_zybszdDTO) o;
