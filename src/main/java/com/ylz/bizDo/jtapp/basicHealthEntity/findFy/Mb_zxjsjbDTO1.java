...
/**
 * Created by zzl on 2017/10/30.
 */
public class Mb_zxjsjbDTO1 {
    ...
    private List<Yyqk> yyqkList	;//	用药情况
    ...
    public List<Yyqk> getYyqkList() {
        return yyqkList;
    }

    public void setYyqkList(List<Yyqk> yyqkList) {
