 ...
 */
public class AppDrugGuideEntity {
    ...
    public String getDrugPeriod() throws Exception {
    ...
    public String getDrugFrequency() throws Exception {
    ...
    public void setDgDosageUnit(String dgDosageUnit) throws Exception {
        if(StringUtils.isNotBlank(dgDosageUnit)){
            SysDao dao =  (SysDao) SpringHelper.getBean("sysDao");
            CdCode value = dao.getCodeDao().findCodeGroupValue(CodeGroupConstrats.GROUP_DRUGDOSAGEUNIT, dgDosageUnit);
            if(value!=null) {
                this.dgDosageUnit = value.getCodeTitle();
            }
        }
    }
    ...
    public void setDgAllDosageUnit(String dgAllDosageUnit) throws Exception {
        if(StringUtils.isNotBlank(dgAllDosageUnit)){
            SysDao dao =  (SysDao) SpringHelper.getBean("sysDao");
            CdCode value = dao.getCodeDao().findCodeGroupValue(CodeGroupConstrats.GROUP_DRUGDOSAGEUNIT, dgAllDosageUnit);
            if(value!=null) {
                this.dgAllDosageUnit = value.getCodeTitle();
            }
        }
    }
}
