 ...
 * 登录
 */
public class AppPatientUserWechatEntity {
    private String id;
...
//     * @return
//     */
//    public AppGluEntity getStrBloodglu(){
...
//     * @return
//     */
//    public AppPressureEntity getStrBloodpress(){
//        if(StringUtils.isNotBlank(this.getId())){
//            SysDao dao =  (SysDao) SpringHelper.getBean("sysDao");
...
//     * @return
//     */
//    public List<AppMenuEntity> getStrPatientMenuRole(){
...
//     * @return
//     */
//    public List<AppMyServiceEntity> getMyServiceMenu(){
//        SysDao dao =  (SysDao) SpringHelper.getBean("sysDao");
//        AppMenuRoleQvo qvo = new AppMenuRoleQvo();
