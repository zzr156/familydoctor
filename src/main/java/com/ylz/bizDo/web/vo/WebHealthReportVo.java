 ...
 */
public class WebHealthReportVo {
    ...
    private String healthReportState;//报告状态
    ...
    public String getHealthReportState() {
        return healthReportState;
    }

    public void setHealthReportState(String healthReportState) {
        this.healthReportState = healthReportState;
    }
}
