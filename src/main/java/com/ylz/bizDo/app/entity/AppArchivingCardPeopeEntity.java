 ...
 */
public class AppArchivingCardPeopeEntity {
     ...
     * @return
     */
    public String getAddrHospName(){
        if(StringUtils.isNotBlank(this.getAddrHospId())){
            SysDao dao = (SysDao)SpringHelper.getBean("sysDao");
            AppHospDept dept = (AppHospDept)dao.getServiceDo().find(AppHospDept.class,this.getAddrHospId());
            if(dept != null ){
                return dept.getHospName();
            }
        }
