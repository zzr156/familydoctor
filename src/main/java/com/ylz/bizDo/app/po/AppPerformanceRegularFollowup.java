 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_REGULAR_FOLLOWUP")
public class AppPerformanceRegularFollowup  extends BasePO {
    ...
    @Column(name="PER_FOLLOW_TYPE", length=10)
    private String perFollowType;//随访类型 随访类型 5 高血压,6 糖尿病,7精神病,8结核病,1新生儿访视,2儿童体检
    @Column(name="PER_FOLLOW_NEXT_DATE", length=10)
    private String perFollowNextDate;//随访下次时间
    ...
    /** default constructor */
    public AppPerformanceRegularFollowup() {
    }

    /** minimal constructor */
    public AppPerformanceRegularFollowup(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceRegularFollowup(String id, String perName, String perIdno,
                                         String perDrId, String perDrName, String perHospId,
                                         String perHospName, String perAreaCode, Calendar perCreateDate,
                                         String perYear, String perMonth, String perYearMonth,String perSource,String perFollowType) {
        this.id = id;
