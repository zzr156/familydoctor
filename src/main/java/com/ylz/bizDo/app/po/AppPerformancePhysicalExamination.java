 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_PHYSICAL_EXAMINATION")
public class AppPerformancePhysicalExamination extends BasePO {
    ...
    /** default constructor */
    public AppPerformancePhysicalExamination() {
    }

    /** minimal constructor */
    public AppPerformancePhysicalExamination(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformancePhysicalExamination(String id, String perName, String perIdno,
