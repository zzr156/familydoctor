 ...
 */
@Entity
@Table(name = "APP_LABEL_DISEASE")
public class AppLabelDisease extends BasePO {
	...
	/** default constructor */
	public AppLabelDisease() {
	}

	/** minimal constructor */
	public AppLabelDisease(String id) {
		this.id = id;
	}

	/** full constructor */
	public AppLabelDisease(String id, String labelSignId, String labelTeamId,
