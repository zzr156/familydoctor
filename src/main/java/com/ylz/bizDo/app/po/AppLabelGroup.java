...
public class AppLabelGroup extends BasePO {
	...
	/** default constructor */
	public AppLabelGroup() {
	}

	/** minimal constructor */
	public AppLabelGroup(String id) {
		this.id = id;
	}

	/** full constructor */
	public AppLabelGroup(String id, String labelSignId, String labelTeamId,
