 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_CONSTITUTION_IDENTIFICATION")
public class AppPerformanceConstitutionIdentification extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceConstitutionIdentification() {
    }

    /** minimal constructor */
    public AppPerformanceConstitutionIdentification(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceConstitutionIdentification(String id, String perName, String perIdno,
