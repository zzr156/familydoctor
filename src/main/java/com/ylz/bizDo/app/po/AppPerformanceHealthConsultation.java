 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_HEALTH_CONSULTATION")
public class AppPerformanceHealthConsultation  extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceHealthConsultation() {
    }

    /** minimal constructor */
    public AppPerformanceHealthConsultation(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceHealthConsultation(String id, String perName, String perIdno,
