 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_VACCINATION")
public class AppPerformanceVaccination extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceVaccination() {
    }

    /** minimal constructor */
    public AppPerformanceVaccination(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceVaccination(String id, String perName, String perIdno,
