 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_POSTPARTUM_VISIT")
public class AppPerformancePostpartumVisit extends BasePO {
    ...
    /** default constructor */
    public AppPerformancePostpartumVisit() {
    }

    /** minimal constructor */
    public AppPerformancePostpartumVisit(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformancePostpartumVisit(String id, String perName, String perIdno,
