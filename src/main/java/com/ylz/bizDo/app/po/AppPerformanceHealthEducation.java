 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_HEALTH_EDUCATION")
public class AppPerformanceHealthEducation extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceHealthEducation() {
    }

    /** minimal constructor */
    public AppPerformanceHealthEducation(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceHealthEducation(String id, String perName, String perIdno,
