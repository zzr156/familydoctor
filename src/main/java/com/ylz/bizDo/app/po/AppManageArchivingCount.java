 ...
 */
@Entity
@Table(name = "APP_MANAGE_ARCHIVING_COUNT")
public class AppManageArchivingCount extends BasePO {
	...
	@Column(name = "MANAGE_TEAM_ID", length = 30)
	...
	@Column(name = "MANAGE_JD_AREA_CODE",length = 30)
	private String manageJdAreaCode;//建档立卡花名册中的街道行政区划
	...
	/** default constructor */
	public AppManageArchivingCount() {
	}

	/** minimal constructor */
	public AppManageArchivingCount(String id) {
		this.id = id;
	}
	...
	public String getManageJdAreaCode() {
		return manageJdAreaCode;
	}

	public void setManageJdAreaCode(String manageJdAreaCode) {
		this.manageJdAreaCode = manageJdAreaCode;
	}
