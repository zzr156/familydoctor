 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_HEALTH_RECORD")
public class AppPerformanceHealthRecord  extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceHealthRecord() {
    }

    /** minimal constructor */
    public AppPerformanceHealthRecord(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceHealthRecord(String id, String perName, String perIdno,
