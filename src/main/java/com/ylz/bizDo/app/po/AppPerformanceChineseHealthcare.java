 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_CHINESE_HEALTHCARE")
public class AppPerformanceChineseHealthcare extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceChineseHealthcare() {
    }

    /** minimal constructor */
    public AppPerformanceChineseHealthcare(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceChineseHealthcare(String id, String perName, String perIdno,
