 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_PRENATAL_CARE")
public class AppPerformancePrenatalCare  extends BasePO {
    ...
    /** default constructor */
    public AppPerformancePrenatalCare() {
    }

    /** minimal constructor */
    public AppPerformancePrenatalCare(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformancePrenatalCare(String id, String perName, String perIdno,
