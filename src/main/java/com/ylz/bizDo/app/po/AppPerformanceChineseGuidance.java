 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_CHINESE_GUIDANCE")
public class AppPerformanceChineseGuidance extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceChineseGuidance() {
    }

	/** minimal constructor */
    public AppPerformanceChineseGuidance(String id) {
        this.id = id;
    }
    
    /** full constructor */
    public AppPerformanceChineseGuidance(String id, String perName, String perIdno,
