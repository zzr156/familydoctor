 ...
 */
@Entity
@Table(name="APP_PERFORMANCE_HEALTH_GUIDANCE")
public class AppPerformanceHealthGuidance  extends BasePO {
    ...
    /** default constructor */
    public AppPerformanceHealthGuidance() {
    }

    /** minimal constructor */
    public AppPerformanceHealthGuidance(String id) {
        this.id = id;
    }

    /** full constructor */
    public AppPerformanceHealthGuidance(String id, String perName, String perIdno,
