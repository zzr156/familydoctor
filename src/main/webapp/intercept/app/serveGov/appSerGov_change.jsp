...
<script type="text/javascript">
    ...
    function show(){
        doAjaxPost('<%=request.getContextPath()%>/appGov.action?act=findHospCmm',{id:$("#serId").val()},function (data) {
            if(data.map!=null){
    ...
    function chageHospDept(){
        ...
        doAjaxPost('<%=request.getContextPath()%>/appGov.action?act=openObject',{id:$("#serId").val(),hospIds:chkRadio},function (data) {

        })
    }
    function openAllHosp(){
        doAjaxPost('<%=request.getContextPath()%>/appGov.action?act=openAllCmm',{id:$("#serId").val()},function (data) {
