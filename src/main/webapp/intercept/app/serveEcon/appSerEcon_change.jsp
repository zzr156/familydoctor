                    ...
                    <tr>
                        <td>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" pofield="deptName"  id="deptName"  >
                                </div>
                            </div>
                        </td>
                    </tr>
...
<script type="text/javascript">
    ...
    function show(){
        doAjaxPost('<%=request.getContextPath()%>/appEcon.action?act=findHospCmm',{id:$("#serId").val()},function (data) {
            if(data.map!=null){
    ...
    function chageHospDept(){
        ...
        doAjaxPost('<%=request.getContextPath()%>/appEcon.action?act=openObject',{id:$("#serId").val(),hospIds:chkRadio},function (data) {

        })
    }
    function openAllHosp(){
        doAjaxPost('<%=request.getContextPath()%>/appEcon.action?act=openAllCmm',{id:$("#serId").val()},function (data) {
