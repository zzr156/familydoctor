...
<script type="text/javascript">
    ...
    function show(){
        doAjaxPost('<%=request.getContextPath()%>/appSerMeal.action?act=findHospCmm',{id:$("#serId").val()},function (data) {
            if(data.map!=null){
    ...
    function chageHospDept(){
        ...
        doAjaxPost('<%=request.getContextPath()%>/appSerMeal.action?act=openObject',{id:$("#serId").val(),hospIds:chkRadio},function (data) {

        })
    }
    function openAllHosp(){
        doAjaxPost('<%=request.getContextPath()%>/appSerMeal.action?act=openAllCmm',{id:$("#serId").val()},function (data) {
