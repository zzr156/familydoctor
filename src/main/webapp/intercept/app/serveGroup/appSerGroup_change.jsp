...
<script type="text/javascript">
    ...
    function show(){
        doAjaxPost('<%=request.getContextPath()%>/appSerGroup.action?act=findHospCmm',{id:$("#serId").val()},function (data) {
            if(data.map!=null){
    ...
    function chageHospDept(){
        ...
        doAjaxPost('<%=request.getContextPath()%>/appSerGroup.action?act=openObject',{id:$("#serId").val(),hospIds:chkRadio},function (data) {

        })
    }
    function openAllHosp(){
        doAjaxPost('<%=request.getContextPath()%>/appSerGroup.action?act=openAllCmm',{id:$("#serId").val()},function (data) {
