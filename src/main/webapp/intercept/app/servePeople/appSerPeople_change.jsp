...
<script type="text/javascript">
    ...
    function show(){
        doAjaxPost('<%=request.getContextPath()%>/appSerPeople.action?act=findHospCmm',{id:$("#serId").val()},function (data) {
            if(data.map!=null){
    ...
    function chageHospDept(){
        ...
        doAjaxPost('<%=request.getContextPath()%>/appPk.action?act=openObject',{id:$("#serId").val(),hospIds:chkRadio},function (data) {

        })
    }
    function openAllHosp(){
        doAjaxPost('<%=request.getContextPath()%>/appPk.action?act=openAllCmm',{id:$("#serId").val()},function (data) {
