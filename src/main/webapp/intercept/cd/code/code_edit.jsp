...
<body class="gray-bg">
			...
			<div class="col-sm-12">
	            <div class="ibox float-e-margins">
	                <div class="ibox-title">
	                	<h5 id="codeAddTit"></h5>                
	                    <a class="label label-primary pull-right system code_list"  onclick="backTable();">返回</a>
	                </div>
	                <div class="ibox-content">
							<form role="form" id="form_vo"  class="form-horizontal">
			                		...
			                		<div class="form-group">
			                            <label class="col-sm-2 control-label"><span class="text-danger">*</span>基础属性名称：</label>
			                            <div class="col-sm-4">					                           
			                                <input id="codeTitle" name="codeTitle" pofield="codeTitle" type="text" class="form-control">
			                            </div>
			                            <label class="col-sm-2 control-label"><span class="text-danger">*</span>基础属性值：</label>
			                            <div class="col-sm-4">					                           
			                                <input id="codeValue" name="codeValue" pofield="codeValue" type="text" class="form-control">
			                            </div>
			                        </div>
			                        <div class="form-group">
			                        	 <label class="col-sm-2 control-label"><span class="text-danger">*</span>组名中文：</label>
			                             <div class="col-sm-4">					                           
			                                <input id="codeRemark" name="codeRemark" pofield="codeRemark" type="text" class="form-control">
			                             </div>
			                             <label class="col-sm-2 control-label"><span class="text-danger">*</span>组名英文：</label>
			                             <div class="col-sm-4">					                           
			                                <input id="codeGroup" name="codeGroup" pofield="codeGroup" type="text" class="form-control">
			                             </div>
			                        </div>
			                        <div class="form-group">
								   ...
								   <div class="text-center btnBar">
			                        	<a id="handleMethod" class="btn btn-primary system code_add" onclick="saveTable();">保存</a>                       	                           
			                       </div>
						      </form>
						 </div>
    ...
    <script type="text/javascript">
		...
		function callDataSave(data){
			if(data.msg == 'true'){
                var url = '<%=request.getContextPath()%>/code.action?act=forList';
                defualtHref(url);
			}else{
				 layer.open({
	    			skin: 'layui-layer-molv',
