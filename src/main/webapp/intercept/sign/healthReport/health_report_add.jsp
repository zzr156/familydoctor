        ...
        <tr>
            ...
            <td pofield="healthCondition" colspan="7">
                ...
                <div style="height: 100px">
                    ...
                    <textarea type="text" style="height:100%;width: 820px;" pofield="summary" id="summary" validator='{"msg":"总结不能为空!"}'></textarea>
                </div>
            </td>
        </tr>
        <tr>
            <td ><b style="color: red;">*</b>健康评价</td>
            <td colspan="7"><textarea style="height: 100px;width: 100%;" type="text" id="healthAssessment" pofield="healthAssessment" validator='{"msg":"健康评价不能为空!"}'></textarea></td>
        </tr>
        <tr>
            <td ><b style="color: red;">*</b>健康指导</td>
            <td colspan="7"><textarea style="height: 100px;width: 100%;" type="text" id="healthGuidance" pofield="healthGuidance" validator='{"msg":"健康指导不能为空!"}'></textarea></td>
        </tr>
        <tr>
            <td >报告医生</td>
...
<div align="center" style="padding:20px;">
    <button id="addReport" class="layui-btn layui-btn-lg layui-btn-normal" onclick="addReport()">生成报告</button>
    <button id="goto" class="layui-btn layui-btn-lg layui-bg-red" style="margin-left: 25px;" onclick="goto()">返回</button>
</div>

</body>
<script type="text/javascript" src="js/health_report_add.js"></script>
