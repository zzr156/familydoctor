...
<div style="padding:0 10px;">
    <form class="layui-form-pane" id="form_vo">
        ...
        <input type="hidden" id="jdSourceType" pofield="jdSourceType">
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">健康档案号</label>
                <div class="layui-input-inline">
                    <input type="text" disabled="disabled" pofield="rhfId" id="rhfId" class="layui-input"/>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">社区(村)</label>
                <div class="layui-input-inline">
                    <input type="hidden" id="addrVillageCode" pofield="addrVillageCode">
                    <input type="hidden" id="addrVillageName" pofield="addrVillageName">
                    <select id="addrVillage" pofield="addrVillage" class="layui-input" onchange="getValueName()">
        ...
        <%--<div class="layui-form-item" id="bz">
            ...
            <div class="layui-input-block">
                <textarea type="text" id="remarks" name="remarks" pofield="remarks" placeholder="请输入备注" class="layui-textarea" ></textarea>
            </div>
        </div>--%>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block" style="text-align: center;">
                ...
                <input type="button" id="roleadd" value="修改" onclick="signModify()" class="layui-btn layui-btn-normal"/>
            </div>
        </div>
    </form>
...
<script type="text/javascript" src="js/archiving_modify.js?v=1.0"></script>
</html>
