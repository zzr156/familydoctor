...
<head>
    ...
    <title>产后访视记录详情</title>
</head>

<body>
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>产后访视记录详情</legend>
</fieldset>
<form class="layui-form layui-form-pane" id="view_chsf_detail">
    <div class="layui-form-item layui-form">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" autocomplete="off" class="layui-input" readonly="readonly" id="tiwen0" name="tiwen0" pofield="tiwen0">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <div class="layui-inline" style="margin-top:10px">
                <div class="layui-input-inline">
                    <input type="text" autocomplete="off" class="layui-input" readonly="readonly"  id="elqt00" name="elqt00" pofield="elqt00">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="fl0000" title="未见异常" lay-skin="primary"  id="fl0000" value="0" pofield="fl0000" disabled>
            <input type="checkbox" name="fl0000" title="异常" lay-skin="primary"  id="fl0000" value="1" pofield="fl0000" disabled>
            <div class="layui-inline" style="margin-top:10px">
                <div class="layui-input-inline">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="zd0000" title="个人卫生" lay-skin="primary" id="zd0000" value="0" pofield="zd0000" disabled>
            <input type="checkbox" name="zd0000" title="心理" lay-skin="primary" id="zd0000" value="0" pofield="zd0000" disabled>
            <input type="checkbox" name="zd0000" title="营养" lay-skin="primary" id="zd0000" value="0" pofield="zd0000" disabled>
            <input type="checkbox" name="zd0000" title="母乳喂养" lay-skin="primary" id="zd0000" value="0" pofield="zd0000" disabled>
            <input type="checkbox" name="zd0000" title="新生儿护理与喂养" lay-skin="primary" id="zd0000" value="0" pofield="zd0000" disabled>
...
<script type="text/javascript" src="js/view_chsf_detail.js?v=1.0"></script>
</html>