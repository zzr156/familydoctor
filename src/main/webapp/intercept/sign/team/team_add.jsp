...
<form class="layui-form-pane" id="form_vo">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  pofield="teamName" class="layui-input" validator='{"msg":"团队名称不能为空!"}'/>
            </div>
            ...
            <div class="layui-input-block">
                ...
                <select id="teamDr" name="teamDr" onchange="addCode()" class="layui-input" data-live-search="true"  validator='{"msg":"团队负责人不能为空!"}'></select>
            </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <input type="button" id="roleadd" value="保存" onclick="teamAdd()" class="layui-btn" />
...
<script type="text/javascript" src="js/team_add.js?v=1.0"></script>
