       ...
       Chart_zdrq.setOption(option1);
        ...
        Chart_qyzt.on('click', function (params) {
            if(orglist[params.dataIndex].length>10){
                window.location.href="echartses_admin.jsp?Etype=false&orgValue="+orglist[params.dataIndex]+"&goto=2&orgValues="+orgValue+"&Etypes="+Etype+"&CodeNmae="+params.name;
            }else {
                window.location.href="echartses_admin.jsp?Etype=true&orgValue="+orglist[params.dataIndex]+"&goto=2&orgValues="+orgValue+"&Etypes="+Etype+"&CodeNmae="+params.name;
...
function signsx(){
    ...
    /*if(goto=="1"){
        window.location.href="intercept/sign/echarts/echartses_admin.jsp?Etype="+Etype+"&orgValue="+orgValue+"&goto="+goto;
    }else if(goto=="2"){
        window.location.href="intercept/sign/echarts/echartses_admin.jsp?Etype="+Etype+"&orgValue="+orgValue+"&goto=2&orgValues="+orgValues+"&Etypes="+Etypes;
    }*/
   onede();
    // history.go(0);
}
...
function signgoto(){
    ...
    if(upWebAreaCode == '350000000000'){
        window.location.href="echarts_admin.jsp?&CodeNmae="+CodeNmae;
    }else {
        window.location.href="echartses_admin.jsp?Etype="+Etypes+"&orgValue="+upWebAreaCode+"&goto=1&CodeNmae="+CodeNmae;
    }
}
