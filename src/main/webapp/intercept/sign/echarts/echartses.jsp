...
<div style="width: 100%;height: 100%">
    ...
    <button class="layui-btn" id="comeback" onclick="signgoto();">返回</button>
    <div  align="center" >
        <span style="font-size: 40px;"  id="OrgName" name="OrgName">家庭医生签约服务情况统计</span>
        <fieldset ><legend  ><span  style="font-size: 20px;"> </span></legend>
           <%-- <div style="display: inline;text-align:center"> <h2 style="font-size:25px;    padding: 6px 0;">已签约人数：<span id="demoid"></span>  未签约人数 : <span id="wdemo"></span>  (管理人数 : <span id="signsum"></span> ) </h2>
            ...
            <div style="display: inline;text-align:center"> <h2 style="font-size:25px;    padding: 6px 0;">截止：<span id="demodate"></span>,  已签约人数：<span id="demoid"></span>,  有偿签约人数 : <span id="ycdemo"></span>,  重点签约人数 : <span id="zddemo"></span>,重点（经济类型）签约人数：<span id="zdjjdemo"></span>  </h2>
            </div>
            ...
            <div style="text-align: left">
                <span style="font-size: 15px;text-align: left">重点人群（经济类型）签约率：</span>
            </div>
...
<script type="text/javascript" src="js/echartses.js"></script>
