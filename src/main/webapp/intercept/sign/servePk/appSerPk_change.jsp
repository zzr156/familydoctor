...
<script type="text/javascript">
    ...
    function findDept(areaCode){
        doAjaxPost('openapphosp.action?act=findAllCmm',{},function (data) {
            $("#tbHospDept").html("");
    ...
    function show(){
        doAjaxPost('openappPk.action?act=findHospCmm',{id:$("#serId").val()},function (data) {
            if(data.map!=null){
    ...
    function chageHospDept(){
        ...
        doAjaxPost('openappPk.action?act=openObject',{id:$("#serId").val(),hospIds:chkRadio},function (data) {
            if(!data.mag=="true"){
                showMsg(data.msg);
            }
        })
    ...
    function openAllHosp(){
        doAjaxPost('openappPk.action?act=openAllCmm',{id:$("#serId").val()},function (data) {
            if(!data.mag=="true"){
                showMsg(data.msg);
            }
        })
