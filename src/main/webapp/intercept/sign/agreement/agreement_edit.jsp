...
<form class="layui-form-pane" id="form_vo">
	...
	<div class="layui-form-item">
		<div class="layui-input-block" style="text-align: center;">
			<input type="button" id="roleadd" value="修改保存" onclick="saveTable()" class="layui-btn layui-btn-normal"/>
			<input type="button" id="" value="返回" onclick="goto()" class="layui-btn layui-btn-normal"/>
		</div>
	</div>
</form>
</body>
<script type="text/javascript" src="js/agreement_edit.js?v=1.0"></script>
</html>
