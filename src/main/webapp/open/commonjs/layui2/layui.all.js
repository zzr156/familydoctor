...
layui.define("jquery", function (i) {
    "use strict";
    var t = layui.$, a = (layui.hint(), layui.device()), l = "element", e = "layui-this", n = "layui-show",
        s = function () {
            this.config = {}
        };
    s.prototype.set = function (i) {
        ...
        return layui.onevent.call(this, l, i, t)
    }, s.prototype.tabAdd = function (i, a) {
        var l = ".layui-tab-title", e = t(".layui-tab[lay-filter=" + i + "]"), n = e.children(l),
        ...
        i = i || {}, b.on("click", i.headerElem, function (a) {
            var l = t(this).index();
            f.tabClick.call(this, a, l, null, i)
        })
    }, s.prototype.progress = function (i, a) {
        var l = "layui-progress", e = t("." + l + "[lay-filter=" + i + "]"), n = e.find("." + l + "-bar"),
            s = n.find("." + l + "-text");
    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child",
        h = "layui-nav-more", y = "layui-anim layui-anim-upbit", f = {
            tabClick: function (i, a, s, o) {
                ...
                "javascript:;" !== d.attr("href") && "_blank" === d.attr("target") || (c.addClass(e).siblings().removeClass(e), u.eq(a).addClass(n).siblings().removeClass(n)), layui.event.call(this, l, "tab(" + h + ")", {
                    elem: r,
                    index: a
                })
                ...
                n.hasClass(e) && (n.next()[0] ? f.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && f.tabClick.call(n.prev()[0], null, s - 1)), n.remove(), c.eq(s).remove(), setTimeout(function () {
                    f.tabAuto()
                }, 50), layui.event.call(this, l, "tabDelete(" + r + ")", {elem: o, index: s})
            }, tabAuto: function () {
                ...
                t(".layui-tab").each(function () {
                    ...
                    if (n === window && 8 != a.ie && f.hideTabMore(!0), s.attr("lay-allowClose") && o.find("li").each(function () {
                            var i = t(this);
                            if (!i.find("." + e)[0]) {
                                var a = t('<i class="layui-icon layui-unselect ' + e + '">&#x1006;</i>');
                ...
                i.find("." + d)[0] || ("javascript:;" !== s.attr("href") && "_blank" === s.attr("target") || c || (a.find("." + e).removeClass(e), i.addClass(e)), layui.event.call(this, l, "nav(" + n + ")", i))
            }, clickChild: function () {
                var i = t(this), a = i.parents(o), n = a.attr("lay-filter");
                a.find("." + e).removeClass(e), i.addClass(e), layui.event.call(this, l, "nav(" + n + ")", i)
            }, showChild: function () {
                var i = t(this), a = i.parents(o), l = i.parent(), e = i.siblings("." + d);
                a.hasClass(u) && (e.removeClass(y), l["none" === e.css("display") ? "addClass" : "removeClass"](c + "ed"))
            }, collapse: function () {
                var i = t(this), a = i.find(".layui-colla-icon"), e = i.siblings(".layui-colla-content"),
                ...
                e[c ? "addClass" : "removeClass"](n), a.html(c ? "&#xe61a;" : "&#xe602;"), layui.event.call(this, l, "collapse(" + o + ")", {
                    title: i,
                    content: e,
                    show: c
                })
    ...
    s.prototype.init = function (i, l) {
        var e = function () {
            return l ? '[lay-filter="' + l + '"]' : ""
        }(), s = {
            tab: function () {
                f.tabAuto.call({})
            }, nav: function () {
                var i = 200, l = {}, s = {}, p = {}, b = function (e, o, c) {
                ...
                t(o + e).each(function (a) {
                    var e = t(this), o = t('<span class="' + r + '"></span>'), y = e.find("." + c);
                    e.find("." + r)[0] || (e.append(o), y.on("mouseenter", function () {
                        b.call(this, o, e, a)
                    }).on("mouseleave", function () {
                        e.hasClass(u) || (clearTimeout(s[a]), s[a] = setTimeout(function () {
                            e.find("." + d).removeClass(n), e.find("." + h).removeClass(h + "d")
                        }, 300))
                    }), e.on("mouseleave", function () {
                        clearTimeout(l[a]), p[a] = setTimeout(function () {
                            e.hasClass(u) ? o.css({
                                height: 0,
                ...
                t(i + e).each(function () {
                    var i = t(this), a = i.attr("lay-separator") || ">", l = i.find("a");
                    l.find(".layui-box")[0] || (l.each(function (i) {
                        i !== l.length - 1 && t(this).append('<span class="layui-box">' + a + "</span>")
                    }), i.css("visibility", "visible"))
                })
            }, progress: function () {
                var i = "layui-progress";
                t("." + i + e).each(function () {
                    var a = t(this), l = a.find(".layui-progress-bar"), e = l.attr("lay-percent");
                    l.css("width", e), a.attr("lay-showPercent") && setTimeout(function () {
                        var t = Math.round(l.width() / a.width() * 100);
                        t > 100 && (t = 100), l.html('<span class="' + i + '-text">' + t + "%</span>")
                    }, 350)
                })
            }, collapse: function () {
                ...
                t("." + i + e).each(function () {
                    ...
                    i.each(function () {
                        var i = t(this), a = i.find(".layui-colla-title"), l = i.find(".layui-colla-content"),
                            e = "none" === l.css("display");
                        a.find(".layui-colla-icon").remove(), a.append('<i class="layui-icon layui-colla-icon">' + (e ? "&#xe602;" : "&#xe61a;") + "</i>"), a.off("click", f.collapse).on("click", f.collapse)
                    })
                })
            }
        };
    ...
    b.on("click", v, f.tabClick), b.on("click", f.hideTabMore), t(window).on("resize", f.tabAuto), i(l, p)
});
    ...
    H.prototype.config = {limit: 30, loading: !0}, H.prototype.render = function (e) {
        ...
        var c = this, s = c.config, u = e[s.response.dataName] || [], f = [], y = [], p = [], m = function () {
            return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u, function (e, a) {
                a.myIndex = parseInt(e + 1) + ((pn - 1) * ps);
                var l = [], n = [], o = [];
